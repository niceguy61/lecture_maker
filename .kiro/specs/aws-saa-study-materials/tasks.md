...
- [-] 3. Week 1 Day 2 학습 자료 생성
  - [ ] 3.1 Day 2 이론 콘텐츠 작성 (IAM)
  - [ ] 3.2 Day 2 시각화 자료 생성 (IAM 아키텍처 다이어그램)
  - [ ] 3.3 Day 2 Python 실습 코드 작성 (IAM 관리)
  - [ ] 3.4 Day 2 퀴즈 작성 (5문제)
  - _Requirements: 2.1, 2.3, 3.1, 4.1_

- [ ] 4. Week 1 Day 3 학습 자료 생성
  - [ ] 4.1 Day 3 이론 콘텐츠 작성 (EC2 기초)
  - [ ] 4.2 Day 3 시각화 자료 생성 (EC2 아키텍처)
  - [ ] 4.3 Day 3 Python 실습 코드 작성 (EC2 관리)
  - [ ] 4.4 Day 3 퀴즈 작성 (5문제)
  - _Requirements: 2.1, 2.3, 3.1, 4.1_
