# Troubleshooting: EBS Volumes 문제 해결 가이드

## 📋 문서 정보
- **Day**: 9
- **주요 서비스**: EBS Volumes, EBS Snapshots, EFS, FSx
- **작성일**: {date}
...
**대시보드 이름**: EBS Volumes-monitoring-dashboard

**핵심 메트릭 정의** (Day 9 서비스 기준):
...
**알람 구성 예시**:
```yaml
알람명: EBS Volumes-{metric_name}-alert
...
### 공식 트러블슈팅 가이드
- [EBS Volumes Troubleshooting]({troubleshooting_guide_link})
...
### 서비스별 베스트 프랙티스
- [EBS Volumes Best Practices]({best_practices_link})
