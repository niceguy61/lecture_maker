...
## 🎯 실습 목표
AWS Console을 통해 EBS Volumes를 생성하고 기본 설정을 구성합니다.
...
### Step 1: EBS Volumes 생성

**Console 경로**: `Services > Storage > EBS Volumes`

1. AWS Console 상단의 **Services** 메뉴 클릭
2. **Storage** 카테고리에서 **EBS Volumes** 선택
3. 화면 상단의 **"Create ebs"** 또는 **"Launch ebs"** 버튼 클릭
...
**상태 확인 방법**:
- Console 경로: `EBS Volumes > Resources` 또는 `EBS Volumes > Dashboard`
...
- [ ] EBS Volumes 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
...
#### 1. EBS Volumes 리소스 삭제

**Console 경로**: `EBS Volumes > Resources`

1. 생성한 리소스 선택: `day9-ebs-volumes`
2. **Actions** > **Delete** 클릭
