...
## 🎯 실습 목표
AWS Console을 통해 ElastiCache를 생성하고 기본 설정을 구성합니다.
...
2. **Database** 카테고리에서 **ElastiCache** 선택
3. 화면 상단의 **"Create elasticache"** 또는 **"Launch elasticache"** 버튼 클릭
...
**상태 확인 방법**:
- Console 경로: `ElastiCache > Resources` 또는 `ElastiCache > Dashboard`
...
- [ ] ElastiCache 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
...
#### 1. ElastiCache 리소스 삭제

**Console 경로**: `ElastiCache > Resources`

1. 생성한 리소스 선택: `day12-elasticache`
2. **Actions** > **Delete** 클릭
