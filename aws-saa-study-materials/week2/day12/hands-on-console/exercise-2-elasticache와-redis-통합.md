# Exercise 2: ElastiCache와 Redis 통합

## 🎯 실습 목표
ElastiCache를 Redis와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day12-elasticache 생성됨)
...
**Console 경로**: `Services > AWS Services > Redis`

1. Redis 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. ElastiCache와의 통합 옵션 찾기

---

### Step 2: ElastiCache와 연결

**통합 설정**:
1. ElastiCache 콘솔로 이동
2. 생성한 리소스 선택 (`day12-elasticache`)
...
3. **Use case**: ElastiCache
4. **Permissions**: 
   - ElastiCacheFullAccess
   - RedisFullAccess
5. **Role name**: `day12-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day12-integration-monitoring`
4. 위젯 추가:
   - ElastiCache 메트릭
   - Redis 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `ElastiCache > Integrations`
...
1. 선택: `day12-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
