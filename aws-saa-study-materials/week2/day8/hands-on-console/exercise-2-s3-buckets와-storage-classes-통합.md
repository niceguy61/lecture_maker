# Exercise 2: S3 Buckets와 Storage Classes 통합

## 🎯 실습 목표
S3 Buckets를 Storage Classes와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day8-s3-buckets 생성됨)
...
### Step 1: Storage Classes 설정

**Console 경로**: `Services > AWS Services > Storage Classes`

1. Storage Classes 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. S3 Buckets와의 통합 옵션 찾기

---

### Step 2: S3 Buckets와 연결

**통합 설정**:
1. S3 Buckets 콘솔로 이동
2. 생성한 리소스 선택 (`day8-s3-buckets`)
3. "Integrations" 또는 "Connections" 탭 선택
4. "Add integration" 또는 "Connect" 버튼 클릭
5. Storage Classes 선택 및 설정
...
3. **Use case**: S3 Buckets
4. **Permissions**: 
   - S3 BucketsFullAccess
   - Storage ClassesFullAccess
5. **Role name**: `day8-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. S3 Buckets 콘솔에서 테스트 기능 실행
2. Storage Classes에서 데이터 확인
3. 로그 및 메트릭 확인
...
3. 대시보드 이름: `day8-integration-monitoring`
4. 위젯 추가:
   - S3 Buckets 메트릭
   - Storage Classes 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `S3 Buckets > Integrations`
...
1. 선택: `day8-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
