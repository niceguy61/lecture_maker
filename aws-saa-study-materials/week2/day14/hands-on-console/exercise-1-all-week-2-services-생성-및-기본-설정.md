...
## 🎯 실습 목표
AWS Console을 통해 All Week 2 Services를 생성하고 기본 설정을 구성합니다.
...
### Step 1: All Week 2 Services 생성

**Console 경로**: `Services > AWS Services > All Week 2 Services`

1. AWS Console 상단의 **Services** 메뉴 클릭
2. **AWS Services** 카테고리에서 **All Week 2 Services** 선택
...
**상태 확인 방법**:
- Console 경로: `All Week 2 Services > Resources` 또는 `All Week 2 Services > Dashboard`
...
- [ ] All Week 2 Services 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
...
**테스트 방법**:
1. All Week 2 Services 콘솔에서 생성한 리소스 선택
...
#### 1. All Week 2 Services 리소스 삭제

**Console 경로**: `All Week 2 Services > Resources`

1. 생성한 리소스 선택: `day14-all-week-2-services`
2. **Actions** > **Delete** 클릭
...
1. 검색: `day14` 또는 `all-week-2-services`
2. 선택: 관련 로그 그룹
...
1. **All Week 2 Services 기본 개념**
   - All Week 2 Services의 핵심 기능 및 사용 사례
