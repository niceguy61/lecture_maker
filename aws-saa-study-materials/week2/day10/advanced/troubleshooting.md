# Troubleshooting: RDS 문제 해결 가이드

## 📋 문서 정보
- **Day**: 10
- **주요 서비스**: RDS, Multi-AZ, Read Replicas, Aurora
- **작성일**: {date}
...
**대시보드 이름**: RDS-monitoring-dashboard

**핵심 메트릭 정의** (Day 10 서비스 기준):
...
### 공식 트러블슈팅 가이드
- [RDS Troubleshooting]({troubleshooting_guide_link})
...
### 서비스별 베스트 프랙티스
- [RDS Best Practices]({best_practices_link})
