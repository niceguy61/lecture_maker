# Exercise 2: RDS와 Multi-AZ 통합

## 🎯 실습 목표
RDS를 Multi-AZ와 통합하여 고급 기능을 구성합니다.
...
**Console 경로**: `Services > AWS Services > Multi-AZ`
...
4. **Permissions**: 
   - RDSFullAccess
   - Multi-AZFullAccess
5. **Role name**: `day10-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day10-integration-monitoring`
4. 위젯 추가:
   - RDS 메트릭
   - Multi-AZ 메트릭
   - 통합 상태 메트릭
...
1. 선택: `day10-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
