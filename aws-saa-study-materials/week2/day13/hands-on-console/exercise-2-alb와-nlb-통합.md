# Exercise 2: ALB와 NLB 통합

## 🎯 실습 목표
ALB를 NLB와 통합하여 고급 기능을 구성합니다.
...
**Console 경로**: `Services > AWS Services > NLB`
...
4. **Permissions**: 
   - ALBFullAccess
   - NLBFullAccess
5. **Role name**: `day13-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day13-integration-monitoring`
4. 위젯 추가:
   - ALB 메트릭
   - NLB 메트릭
   - 통합 상태 메트릭
...
1. 선택: `day13-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
