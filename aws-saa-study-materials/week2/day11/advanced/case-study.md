...
**역할**: DynamoDB 가속기를 통한 마이크로초 지연 시간

**구성 방법**:
- DAX 클러스터 생성 및 DynamoDB 연결
...
```yaml
# day11-resource-stack.yaml
AWSTemplateFormatVersion: '2010-09-09'
Description: 'Duolingo - 언어 학습 앱의 NoSQL 데이터베이스 아키텍처 - DynamoDB 구성'

Resources:
  Day11Resource:
    Type: AWS::DynamoDB::Resource
    Properties:
      Name: day11-resource
      Type: Standard
      Tags:
...
```hcl
# main.tf
resource "aws_dynamodb" "day11-resource" {
  name = "day11-resource"
  type = "standard"
  
  tags = {
    Project     = "day11-project"
...
**Console 경로**: CloudWatch > Metrics > DynamoDB
