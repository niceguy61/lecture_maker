# Exercise 2: DynamoDB와 DAX 통합

## 🎯 실습 목표
DynamoDB를 DAX와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day11-dynamodb 생성됨)
...
**Console 경로**: `Services > AWS Services > DAX`

1. DAX 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. DynamoDB와의 통합 옵션 찾기
...
4. **Permissions**: 
   - DynamoDBFullAccess
   - DAXFullAccess
5. **Role name**: `day11-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day11-integration-monitoring`
4. 위젯 추가:
   - DynamoDB 메트릭
   - DAX 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `DynamoDB > Integrations`
...
1. 선택: `day11-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
