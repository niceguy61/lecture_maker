# Exercise 2: All Services Integration와 CloudWatch 통합

## 🎯 실습 목표
All Services Integration를 CloudWatch와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day28-all-services-integration 생성됨)
...
graph TB
    ...
    subgraph "AWS Console - Exercise 2"
        Service1[All Services Integration]
        Service2[CloudWatch]
...
**구성 요소**:
- **All Services Integration**: 메인 리소스
- **CloudWatch**: 통합 서비스
...
### Step 1: CloudWatch 설정

**Console 경로**: `Services > Management & Governance > CloudWatch`

1. CloudWatch 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. All Services Integration와의 통합 옵션 찾기

---

### Step 2: All Services Integration와 연결

**통합 설정**:
1. All Services Integration 콘솔로 이동
2. 생성한 리소스 선택 (`day28-all-services-integration`)
3. "Integrations" 또는 "Connections" 탭 선택
4. "Add integration" 또는 "Connect" 버튼 클릭
5. CloudWatch 선택 및 설정
...
3. **Use case**: All Services Integration
4. **Permissions**: 
   - All Services IntegrationFullAccess
   - CloudWatchFullAccess
5. **Role name**: `day28-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. All Services Integration 콘솔에서 테스트 기능 실행
2. CloudWatch에서 데이터 확인
3. 로그 및 메트릭 확인
...
3. 대시보드 이름: `day28-integration-monitoring`
4. 위젯 추가:
   - All Services Integration 메트릭
   - CloudWatch 메트릭
   - 통합 상태 메트릭
...
- [ ] All Services Integration 통합이 완료되었는가?
- [ ] 연결 상태가 "Connected"인가?
- [ ] IAM 역할이 올바르게 설정되었는가?
- [ ] 테스트가 성공적으로 완료되었는가?
...
**테스트 방법**:
1. All Services Integration에서 작업 수행
2. 연결된 서비스에서 결과 확인
3. 데이터 플로우 검증
...
1. **로그 그룹 찾기**
   - 검색: `/aws/all/services/integration`
   - 또는 리소스 이름으로 검색
...
2. **AWS Console 이벤트 확인**
   - Console 경로: `All Services Integration > Events`
   - 최근 이벤트 및 상태 변경 확인
   - 실패한 작업의 상세 정보 확인
...
**Console 경로**: `All Services Integration > Integrations`
...
1. 선택: `day28-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
...
### 정리 확인
- [ ] 모든 All Services Integration 리소스가 삭제되었는가?
...
2. 현재 월 비용 확인
3. All Services Integration 관련 항목 확인
4. 예상 비용과 비교
...
1. **서비스 통합**
   - All Services Integration와 다른 서비스의 통합 방법
   - IAM 역할을 통한 권한 관리
   - 서비스 간 데이터 플로우
...
- [ ] [Case Study](../case-study.md) 읽기
  - 실제 기업의 All Services Integration 활용 사례
