# Exercise 2: CloudWatch와 Metrics 통합

## 🎯 실습 목표
CloudWatch를 Metrics와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day22-cloudwatch 생성됨)
...
**Console 경로**: `Services > AWS Services > Metrics`

1. Metrics 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. CloudWatch와의 통합 옵션 찾기

---

### Step 2: CloudWatch와 연결

**통합 설정**:
1. CloudWatch 콘솔로 이동
2. 생성한 리소스 선택 (`day22-cloudwatch`)
...
3. **Use case**: CloudWatch
4. **Permissions**: 
   - CloudWatchFullAccess
   - MetricsFullAccess
5. **Role name**: `day22-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day22-integration-monitoring`
4. 위젯 추가:
   - CloudWatch 메트릭
   - Metrics 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `CloudWatch > Integrations`
...
1. 선택: `day22-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
