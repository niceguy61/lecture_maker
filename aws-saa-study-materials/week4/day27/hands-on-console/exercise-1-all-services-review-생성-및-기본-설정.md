...
## 🎯 실습 목표
AWS Console을 통해 All Services Review를 생성하고 기본 설정을 구성합니다.
...
### Step 1: All Services Review 생성

**Console 경로**: `Services > AWS Services > All Services Review`

1. AWS Console 상단의 **Services** 메뉴 클릭
2. **AWS Services** 카테고리에서 **All Services Review** 선택
...
**상태 확인 방법**:
- Console 경로: `All Services Review > Resources` 또는 `All Services Review > Dashboard`
...
- [ ] All Services Review 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
...
**테스트 방법**:
1. All Services Review 콘솔에서 생성한 리소스 선택
...
2. **AWS Console 이벤트 확인**
   - Console 경로: `All Services Review > Events`
   - 최근 이벤트 및 상태 변경 확인
   - 실패한 작업의 상세 정보 확인
...
#### 1. All Services Review 리소스 삭제

**Console 경로**: `All Services Review > Resources`

1. 생성한 리소스 선택: `day27-all-services-review`
2. **Actions** > **Delete** 클릭
...
1. 검색: `day27` 또는 `all-services-review`
2. 선택: 관련 로그 그룹
3. Actions > Delete log group(s)
4. 확인: "Delete" 클릭

### 정리 확인
- [ ] 모든 All Services Review 리소스가 삭제되었는가?
...
2. 현재 월 비용 확인
3. All Services Review 관련 항목 확인
4. 예상 비용과 비교
...
1. **All Services Review 기본 개념**
   - All Services Review의 핵심 기능 및 사용 사례
...
- [ ] [Case Study](../case-study.md) 읽기
  - 실제 기업의 All Services Review 활용 사례
