# Exercise 2: CloudTrail와 GuardDuty 통합

## 🎯 실습 목표
CloudTrail를 GuardDuty와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day23-cloudtrail 생성됨)
...
**Console 경로**: `Services > AWS Services > GuardDuty`

1. GuardDuty 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. CloudTrail와의 통합 옵션 찾기

---

### Step 2: CloudTrail와 연결

**통합 설정**:
1. CloudTrail 콘솔로 이동
2. 생성한 리소스 선택 (`day23-cloudtrail`)
...
3. **Use case**: CloudTrail
4. **Permissions**: 
   - CloudTrailFullAccess
   - GuardDutyFullAccess
5. **Role name**: `day23-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. CloudTrail 콘솔에서 테스트 기능 실행
2. GuardDuty에서 데이터 확인
3. 로그 및 메트릭 확인
...
3. 대시보드 이름: `day23-integration-monitoring`
4. 위젯 추가:
   - CloudTrail 메트릭
   - GuardDuty 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `CloudTrail > Integrations`
...
1. 선택: `day23-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
