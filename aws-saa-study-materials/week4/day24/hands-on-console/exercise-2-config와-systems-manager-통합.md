# Exercise 2: Config와 Systems Manager 통합

## 🎯 실습 목표
Config를 Systems Manager와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day24-config 생성됨)
...
### Step 1: Systems Manager 설정

**Console 경로**: `Services > AWS Services > Systems Manager`

1. Systems Manager 콘솔로 이동
...
4. **Permissions**: 
   - ConfigFullAccess
   - Systems ManagerFullAccess
5. **Role name**: `day24-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. Config 콘솔에서 테스트 기능 실행
2. Systems Manager에서 데이터 확인
3. 로그 및 메트릭 확인
...
3. 대시보드 이름: `day24-integration-monitoring`
4. 위젯 추가:
   - Config 메트릭
   - Systems Manager 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `Config > Integrations`
...
1. 선택: `day24-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
