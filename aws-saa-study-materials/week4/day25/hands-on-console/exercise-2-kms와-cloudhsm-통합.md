# Exercise 2: KMS와 CloudHSM 통합

## 🎯 실습 목표
KMS를 CloudHSM와 통합하여 고급 기능을 구성합니다.
...
**Console 경로**: `Services > AWS Services > CloudHSM`
...
4. **Permissions**: 
   - KMSFullAccess
   - CloudHSMFullAccess
5. **Role name**: `day25-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day25-integration-monitoring`
4. 위젯 추가:
   - KMS 메트릭
   - CloudHSM 메트릭
   - 통합 상태 메트릭
...
1. 선택: `day25-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
