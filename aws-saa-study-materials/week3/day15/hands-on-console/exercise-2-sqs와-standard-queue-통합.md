# Exercise 2: SQS와 Standard Queue 통합

## 🎯 실습 목표
SQS를 Standard Queue와 통합하여 고급 기능을 구성합니다.
...
### Step 1: Standard Queue 설정

**Console 경로**: `Services > AWS Services > Standard Queue`

1. Standard Queue 콘솔로 이동
...
4. **Permissions**: 
   - SQSFullAccess
   - Standard QueueFullAccess
5. **Role name**: `day15-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. SQS 콘솔에서 테스트 기능 실행
2. Standard Queue에서 데이터 확인
3. 로그 및 메트릭 확인
...
3. 대시보드 이름: `day15-integration-monitoring`
4. 위젯 추가:
   - SQS 메트릭
   - Standard Queue 메트릭
   - 통합 상태 메트릭
...
1. 선택: `day15-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
