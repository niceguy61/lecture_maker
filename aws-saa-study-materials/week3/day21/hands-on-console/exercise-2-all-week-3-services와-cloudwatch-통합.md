# Exercise 2: All Week 3 Services와 CloudWatch 통합

## 🎯 실습 목표
All Week 3 Services를 CloudWatch와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day21-all-week-3-services 생성됨)
...
3. All Week 3 Services와의 통합 옵션 찾기

---

### Step 2: All Week 3 Services와 연결

**통합 설정**:
1. All Week 3 Services 콘솔로 이동
2. 생성한 리소스 선택 (`day21-all-week-3-services`)
...
3. **Use case**: All Week 3 Services
4. **Permissions**: 
   - All Week 3 ServicesFullAccess
   - CloudWatchFullAccess
5. **Role name**: `day21-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. All Week 3 Services 콘솔에서 테스트 기능 실행
...
3. 대시보드 이름: `day21-integration-monitoring`
4. 위젯 추가:
   - All Week 3 Services 메트릭
   - CloudWatch 메트릭
   - 통합 상태 메트릭
...
- [ ] All Week 3 Services 통합이 완료되었는가?
- [ ] 연결 상태가 "Connected"인가?
- [ ] IAM 역할이 올바르게 설정되었는가?
- [ ] 테스트가 성공적으로 완료되었는가?
...
2. **AWS Console 이벤트 확인**
   - Console 경로: `All Week 3 Services > Events`
   - 최근 이벤트 및 상태 변경 확인
   - 실패한 작업의 상세 정보 확인
...
**Console 경로**: `All Week 3 Services > Integrations`
...
1. 선택: `day21-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
...
### 정리 확인
- [ ] 모든 All Week 3 Services 리소스가 삭제되었는가?
...
2. 현재 월 비용 확인
3. All Week 3 Services 관련 항목 확인
4. 예상 비용과 비교
...
1. **서비스 통합**
   - All Week 3 Services와 다른 서비스의 통합 방법
   - IAM 역할을 통한 권한 관리
   - 서비스 간 데이터 플로우
...
- [ ] [Case Study](../case-study.md) 읽기
  - 실제 기업의 All Week 3 Services 활용 사례
