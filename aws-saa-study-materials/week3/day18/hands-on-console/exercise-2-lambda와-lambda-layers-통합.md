# Exercise 2: Lambda와 Lambda Layers 통합

## 🎯 실습 목표
Lambda를 Lambda Layers와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day18-lambda 생성됨)
...
### Step 1: Lambda Layers 설정

**Console 경로**: `Services > Application Integration > Lambda Layers`

1. Lambda Layers 콘솔로 이동
...
4. **Permissions**: 
   - LambdaFullAccess
   - Lambda LayersFullAccess
5. **Role name**: `day18-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. Lambda 콘솔에서 테스트 기능 실행
2. Lambda Layers에서 데이터 확인
3. 로그 및 메트릭 확인
...
3. 대시보드 이름: `day18-integration-monitoring`
4. 위젯 추가:
   - Lambda 메트릭
   - Lambda Layers 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `Lambda > Integrations`
...
1. 선택: `day18-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
