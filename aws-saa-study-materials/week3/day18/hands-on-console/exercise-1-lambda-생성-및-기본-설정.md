...
## 🎯 실습 목표
AWS Console을 통해 Lambda를 생성하고 기본 설정을 구성합니다.
...
**Console 경로**: `Services > Application Integration > Lambda`

1. AWS Console 상단의 **Services** 메뉴 클릭
2. **Application Integration** 카테고리에서 **Lambda** 선택
3. 화면 상단의 **"Create lambda"** 또는 **"Launch lambda"** 버튼 클릭
...
**기본 구성**:
- **Function Name**: `day{day_number}-function`
...
**상태 확인 방법**:
- Console 경로: `Lambda > Resources` 또는 `Lambda > Dashboard`
...
- [ ] Lambda 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
