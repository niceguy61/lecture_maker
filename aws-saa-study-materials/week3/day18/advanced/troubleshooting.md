# Troubleshooting: Lambda 문제 해결 가이드
...
**대시보드 이름**: Lambda-monitoring-dashboard

**핵심 메트릭 정의** (Day 18 서비스 기준):
...
### 공식 트러블슈팅 가이드
- [Lambda Troubleshooting]({troubleshooting_guide_link})
...
### 서비스별 베스트 프랙티스
- [Lambda Best Practices]({best_practices_link})
