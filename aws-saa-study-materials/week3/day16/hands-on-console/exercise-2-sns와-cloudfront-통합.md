# Exercise 2: SNS와 CloudFront 통합

## 🎯 실습 목표
SNS를 CloudFront와 통합하여 고급 기능을 구성합니다.
...
### Step 1: CloudFront 설정

**Console 경로**: `Services > Networking > CloudFront`
...
5. **Role name**: `day16-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. SNS 콘솔에서 테스트 기능 실행
2. CloudFront에서 데이터 확인
3. 로그 및 메트릭 확인
...
3. 대시보드 이름: `day16-integration-monitoring`
4. 위젯 추가:
   - SNS 메트릭
   - CloudFront 메트릭
   - 통합 상태 메트릭
...
1. 선택: `day16-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
