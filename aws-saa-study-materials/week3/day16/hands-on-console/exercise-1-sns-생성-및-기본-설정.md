...
## 🎯 실습 목표
AWS Console을 통해 SNS를 생성하고 기본 설정을 구성합니다.
...
**Console 경로**: `Services > AWS Services > SNS`

1. AWS Console 상단의 **Services** 메뉴 클릭
2. **AWS Services** 카테고리에서 **SNS** 선택
3. 화면 상단의 **"Create sns"** 또는 **"Launch sns"** 버튼 클릭
...
**상태 확인 방법**:
- Console 경로: `SNS > Resources` 또는 `SNS > Dashboard`
...
- [ ] SNS 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
