# Exercise 2: Route 53와 DNS 통합

## 🎯 실습 목표
Route 53를 DNS와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day17-route-53 생성됨)
...
**Console 경로**: `Services > AWS Services > DNS`

1. DNS 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. Route 53와의 통합 옵션 찾기
...
4. **Permissions**: 
   - Route 53FullAccess
   - DNSFullAccess
5. **Role name**: `day17-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day17-integration-monitoring`
4. 위젯 추가:
   - Route 53 메트릭
   - DNS 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `Route 53 > Integrations`
...
1. 선택: `day17-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
