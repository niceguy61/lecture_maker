...
## 🎯 실습 목표
AWS Console을 통해 Route 53를 생성하고 기본 설정을 구성합니다.
...
2. **Networking** 카테고리에서 **Route 53** 선택
3. 화면 상단의 **"Create route"** 또는 **"Launch route"** 버튼 클릭
...
**상태 확인 방법**:
- Console 경로: `Route 53 > Resources` 또는 `Route 53 > Dashboard`
...
- [ ] Route 53 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
...
1. 검색: `day17` 또는 `route-53`
2. 선택: 관련 로그 그룹
3. Actions > Delete log group(s)
4. 확인: "Delete" 클릭

### 정리 확인
- [ ] 모든 Route 53 리소스가 삭제되었는가?
