# Troubleshooting: Step Functions 문제 해결 가이드

## 📋 문서 정보
- **Day**: 20
- **주요 서비스**: Step Functions, EventBridge, State Machines, Event Bus
- **작성일**: {date}
...
**대시보드 이름**: Step Functions-monitoring-dashboard

**핵심 메트릭 정의** (Day 20 서비스 기준):
...
**알람 구성 예시**:
```yaml
알람명: Step Functions-{metric_name}-alert
...
### 공식 트러블슈팅 가이드
- [Step Functions Troubleshooting]({troubleshooting_guide_link})
...
### 서비스별 베스트 프랙티스
- [Step Functions Best Practices]({best_practices_link})
