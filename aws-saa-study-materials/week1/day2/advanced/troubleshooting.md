# Troubleshooting: IAM Users 문제 해결 가이드
...
**대시보드 이름**: IAM Users-monitoring-dashboard

**핵심 메트릭 정의** (Day 2 서비스 기준):
...
**알람 구성 예시**:
```yaml
알람명: IAM Users-{metric_name}-alert
...
### 공식 트러블슈팅 가이드
- [IAM Users Troubleshooting]({troubleshooting_guide_link})
...
### 서비스별 베스트 프랙티스
- [IAM Users Best Practices]({best_practices_link})
