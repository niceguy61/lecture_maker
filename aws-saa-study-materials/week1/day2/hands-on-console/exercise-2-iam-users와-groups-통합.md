# Exercise 2: IAM Users와 Groups 통합

## 🎯 실습 목표
IAM Users를 Groups와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day2-iam-users 생성됨)
...
**Console 경로**: `Services > AWS Services > Groups`

1. Groups 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. IAM Users와의 통합 옵션 찾기

---

### Step 2: IAM Users와 연결

**통합 설정**:
1. IAM Users 콘솔로 이동
2. 생성한 리소스 선택 (`day2-iam-users`)
...
3. **Use case**: IAM Users
4. **Permissions**: 
   - IAM UsersFullAccess
   - GroupsFullAccess
5. **Role name**: `day2-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day2-integration-monitoring`
4. 위젯 추가:
   - IAM Users 메트릭
   - Groups 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `IAM Users > Integrations`
...
1. 선택: `day2-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
