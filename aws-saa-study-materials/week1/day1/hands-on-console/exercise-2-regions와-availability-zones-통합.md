# Exercise 2: Regions와 Availability Zones 통합

## 🎯 실습 목표
Regions를 Availability Zones와 통합하여 고급 기능을 구성합니다.
...
- [ ] Exercise 1 완료 (day1-regions 생성됨)
...
### Step 1: Availability Zones 설정

**Console 경로**: `Services > AWS Services > Availability Zones`

1. Availability Zones 콘솔로 이동
2. 새 리소스 생성 또는 기존 리소스 선택
3. Regions와의 통합 옵션 찾기
...
4. **Permissions**: 
   - RegionsFullAccess
   - Availability ZonesFullAccess
5. **Role name**: `day1-integration-role`
6. "Create role" 클릭
...
**테스트 방법**:
1. Regions 콘솔에서 테스트 기능 실행
2. Availability Zones에서 데이터 확인
3. 로그 및 메트릭 확인
...
3. 대시보드 이름: `day1-integration-monitoring`
4. 위젯 추가:
   - Regions 메트릭
   - Availability Zones 메트릭
   - 통합 상태 메트릭
...
**Console 경로**: `Regions > Integrations`
...
1. 선택: `day1-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
