# Exercise 2: VPC와 Subnets 통합

## 🎯 실습 목표
VPC를 Subnets와 통합하여 고급 기능을 구성합니다.
...
**Console 경로**: `Services > AWS Services > Subnets`
...
4. **Permissions**: 
   - VPCFullAccess
   - SubnetsFullAccess
5. **Role name**: `day5-integration-role`
6. "Create role" 클릭
...
3. 대시보드 이름: `day5-integration-monitoring`
4. 위젯 추가:
   - VPC 메트릭
   - Subnets 메트릭
   - 통합 상태 메트릭
...
1. 선택: `day5-integration-monitoring`
2. Delete dashboard
3. 확인: "Delete" 클릭
