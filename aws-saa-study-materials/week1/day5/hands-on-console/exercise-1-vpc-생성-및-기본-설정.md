...
## 🎯 실습 목표
AWS Console을 통해 VPC를 생성하고 기본 설정을 구성합니다.
...
2. **Networking** 카테고리에서 **VPC** 선택
3. 화면 상단의 **"Create vpc"** 또는 **"Launch vpc"** 버튼 클릭
...
**상태 확인 방법**:
- Console 경로: `VPC > Resources` 또는 `VPC > Dashboard`
...
- [ ] VPC 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
