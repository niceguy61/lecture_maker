...
**대시보드 이름**: VPC-monitoring-dashboard

**핵심 메트릭 정의** (Day 5 서비스 기준):
...
### 공식 트러블슈팅 가이드
- [VPC Troubleshooting]({troubleshooting_guide_link})
...
### 서비스별 베스트 프랙티스
- [VPC Best Practices]({best_practices_link})
