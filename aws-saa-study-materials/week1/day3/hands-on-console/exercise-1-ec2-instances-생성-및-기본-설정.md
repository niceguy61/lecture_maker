...
## 🎯 실습 목표
AWS Console을 통해 EC2 Instances를 생성하고 기본 설정을 구성합니다.
...
### Step 1: EC2 Instances 생성

**Console 경로**: `Services > Compute > EC2 Instances`

1. AWS Console 상단의 **Services** 메뉴 클릭
2. **Compute** 카테고리에서 **EC2 Instances** 선택
3. 화면 상단의 **"Create ec2"** 또는 **"Launch ec2"** 버튼 클릭
...
**상태 확인 방법**:
- Console 경로: `EC2 Instances > Resources` 또는 `EC2 Instances > Dashboard`
...
- [ ] EC2 Instances 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
...
**테스트 방법**:
1. EC2 Instances 콘솔에서 생성한 리소스 선택
...
#### 1. EC2 Instances 리소스 삭제

**Console 경로**: `EC2 Instances > Resources`

1. 생성한 리소스 선택: `day3-ec2-instances`
2. **Actions** > **Delete** 클릭
...
1. **EC2 Instances 기본 개념**
   - EC2 Instances의 핵심 기능 및 사용 사례
