...
## 🎯 실습 목표
AWS Console을 통해 Auto Scaling를 생성하고 기본 설정을 구성합니다.
...
### Step 1: Auto Scaling 생성

**Console 경로**: `Services > Compute > Auto Scaling`

1. AWS Console 상단의 **Services** 메뉴 클릭
2. **Compute** 카테고리에서 **Auto Scaling** 선택
3. 화면 상단의 **"Create auto"** 또는 **"Launch auto"** 버튼 클릭
...
**상태 확인 방법**:
- Console 경로: `Auto Scaling > Resources` 또는 `Auto Scaling > Dashboard`
...
- [ ] Auto Scaling 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
...
**테스트 방법**:
1. Auto Scaling 콘솔에서 생성한 리소스 선택
...
#### 1. Auto Scaling 리소스 삭제

**Console 경로**: `Auto Scaling > Resources`

1. 생성한 리소스 선택: `day4-auto-scaling`
2. **Actions** > **Delete** 클릭
...
1. **Auto Scaling 기본 개념**
   - Auto Scaling의 핵심 기능 및 사용 사례
