# Troubleshooting: Auto Scaling 문제 해결 가이드
...
**대시보드 이름**: Auto Scaling-monitoring-dashboard

**핵심 메트릭 정의** (Day 4 서비스 기준):
...
**알람 구성 예시**:
```yaml
알람명: Auto Scaling-{metric_name}-alert
...
### 공식 트러블슈팅 가이드
- [Auto Scaling Troubleshooting]({troubleshooting_guide_link})
...
### 서비스별 베스트 프랙티스
- [Auto Scaling Best Practices]({best_practices_link})
