...
- **주요 AWS 서비스**: Auto Scaling, Load Balancing, Placement Groups, Elastic IP
- **사례 출처**: https://aws.amazon.com/architecture/customers/uber <!-- 공개 자료 링크 또는 "AWS Well-Architected Framework 기반" -->
...
실시간 차량 매칭을 위한 고가용성 컴퓨팅를 위한 확장 가능하고 안정적인 인프라 구축
...
1. **Console 경로**: Services > Storage > Auto Scaling
2. **주요 설정**:
   - Region: day4-resource
...
sequenceDiagram
    ...
    participant Service as Auto Scaling
...
**Console 경로**: Services > Compute > Auto Scaling > Create Resource

**기본 설정**:
- **Name/ID**: `day4-resource`
...
**통합 시나리오 설명**:
- Day 4의 서비스들이 전체 아키텍처에서 핵심 역할 수행

**서비스 의존성**:
- Day 4 (Auto Scaling) → Day 3 (EC2 Instances)
- Day 3 (EC2 Instances) → Day 13 (ALB)
...
### AWS 공식 문서
- [Auto Scaling 사용 설명서](https://docs.aws.amazon.com/auto-scaling/latest/userguide/)
- [Auto Scaling API 레퍼런스](https://docs.aws.amazon.com/auto-scaling/latest/userguide/)
- [AWS Well-Architected Framework - Operational Excellence](https://docs.aws.amazon.com/wellarchitected/latest/framework/)

### 아키텍처 및 베스트 프랙티스
- [AWS 아키텍처 센터 - 실시간 차량 매칭을 위한 고가용성 컴퓨팅](https://aws.amazon.com/architecture/)
- [Auto Scaling 베스트 프랙티스](https://docs.aws.amazon.com/auto-scaling/latest/userguide/)
- [보안 베스트 프랙티스 - IAM Best Practices](https://docs.aws.amazon.com/security/)

### 비용 최적화
- [AWS 요금 계산기](https://calculator.aws/)
- [Auto Scaling 요금 안내](https://aws.amazon.com/pricing)
- [비용 최적화 가이드](https://docs.aws.amazon.com/cost-management/)

### 기업 사례 및 발표 자료
- [Uber 공식 블로그 포스트](https://aws.amazon.com/architecture/customers/uber)
- [AWS re:Invent 발표: Uber - 실시간 차량 매칭을 위한 고가용성 컴퓨팅](https://reinvent.awsevents.com/)
...
### 1. Auto Scaling의 실제 활용 방법
- Auto Scaling의 핵심 기능 이해
- 실제 프로덕션 환경 구성 방법
- 모범 사례 및 안티 패턴
...
**기본 정보**:
- `4`: 일차 번호 (1-28)
- `EC2 고급 기능`: 일별 학습 주제 제목
- `Uber`: 기업명 (실제 또는 가상)
- `실시간 차량 매칭을 위한 고가용성 컴퓨팅`: 사례 연구 초점 (예: "글로벌 스트리밍 아키텍처")

**서비스 정보**:
- `Auto Scaling, Load Balancing, Placement Groups, Elastic IP`: 주요 AWS 서비스 목록 (쉼표로 구분)
- `Auto Scaling`: 주요 서비스 단수형
- `CloudWatch`: 연계 서비스명
...
**URL 및 링크**:
- `https://docs.aws.amazon.com/auto-scaling/latest/userguide/`: AWS 공식 문서 URL
- `https://docs.aws.amazon.com/auto-scaling/latest/userguide/`: API 레퍼런스 URL
- `https://aws.amazon.com/architecture/customers/uber`: 기업 블로그 URL
