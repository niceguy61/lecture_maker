# Hands-On Console: All Week 1 Services 실습 가이드

## 🎯 실습 개요
이 실습에서는 Day 7에서 학습한 **All Week 1 Services**을 AWS Console을 통해 직접 구성하고 테스트합니다.

**학습 목표**:
- All Week 1 Services의 핵심 기능을 Console에서 직접 구성
...
### 실습 환경 정보
- **예상 비용**: $$0.50 - $2.00 (t2.micro/t3.micro 인스턴스 사용 시)
  - Free Tier 범위 내: 해당 없음
  - Free Tier 초과: All Week 1 Services
- **소요 시간**: 약 30-45분분
- **권장 리전**: ap-northeast-2 (서울)
- **필요한 권한**: All Week 1 ServicesFullAccess 또는 관리자 권한
...
**아키텍처 설명**:
- All Week 1 Services를 중심으로 한 실습 환경
- 주요 구성 요소: All Week 1 Services
...
1. **All Week 1 Services 리소스 생성**: AWS Console을 통해 All Week 1 Services를 생성하고 기본 설정을 구성합니다
...
### Exercise 1: All Week 1 Services 생성 및 기본 설정
**목표**: AWS Console을 통해 All Week 1 Services를 생성하고 기본 설정을 구성합니다.

**예상 소요 시간**: 10-15분

**단계**:

1. **All Week 1 Services 생성**
   - Console 경로: Services > Networking > All Week 1 Services
   - 화면 상단의 "Create all" 버튼 클릭
   
2. **기본 설정**
   - **Name**: `day7-all-week-1-services`
     - 명명 규칙: day 번호 + 리소스 유형
     - 예시: `day8-my-bucket`
...
4. **태그 추가** (권장)
   ...
   - 다음 태그 추가:
     | Key | Value | 설명 |
     |-----|-------|------|
     | Name | day7-all-week-1-services | 리소스 식별 |
...
**목표**: All Week 1 Services와 다른 서비스를 통합합니다.
...
2. **기본 설정**
   - **Name**: `day7-monitoring`
   - **Region**: `ap-northeast-2` (서울)
   - **Interval**: 5 minutes
   - **Retention**: 7 days

3. **All Week 1 Services와 연결**
   - "All Week 1 Services integration" 또는 "Attach All Week 1 Services" 섹션으로 이동
   - 이전에 생성한 `day7-all-week-1-services` 선택
   - 연결 옵션 구성:
     - **Auto-enable**: Yes
...
4. **권한 설정**
   ...
   - 옵션 선택:
     - [ ] 기존 역할 사용: 기존 역할 없음
     - [x] 새 역할 생성 (권장)
       - 역할 이름: `day7-all-week-1-services-role`
       - 정책: All Week 1 ServicesFullAccess, CloudWatchFullAccess

5. **생성 및 연결 확인**
   - "Create" 또는 "Attach" 버튼 클릭
   - 생성 완료 대기
   - 연결 상태 확인:
     - Console 경로: All Week 1 Services > all-week-1-services > Integrations
     - CloudWatch 연결 상태: Connected

**검증**:
- [ ] CloudWatch가 정상적으로 생성되었는가?
- [ ] All Week 1 Services와 연결이 완료되었는가?
- [ ] IAM 역할이 올바르게 설정되었는가?
- [ ] 연결 테스트가 성공하는가?

**연결 테스트 방법**:
1. Console 경로: All Week 1 Services > all-week-1-services
...
1. **CloudWatch 대시보드 생성**
   ...
   - 대시보드 이름: `day7-All Week 1 Services-monitoring`
...
2. **위젯 추가 - 메트릭 차트**
   ...
   - 메트릭 선택:
     ...
     - Dimensions: All Week 1 ServicesName
   - 위젯 제목: "요청 수"
   - "Create widget" 클릭
...
4. **알람 생성**
   ...
   - **알림 설정**:
     ...
     - Topic name: `day7-alerts`
     - Email endpoint: your-email@example.com
     - "Create topic" 클릭
   
   - **알람 이름**:
     - Alarm name: `day7-{metric_name}-alert`
     - Alarm description: All Week 1 Services 성능 알람
...
2. **기능 테스트**
   - Console 경로: {service} > all-week-1-services
   - 기본 기능 테스트:
...
3. **성능 확인**
   - Console 경로: CloudWatch > Dashboards > day7-All Week 1 Services-monitoring
   - 확인 항목:
     - 응답 시간: < 100ms
     - 처리량: > 100 TPS
     - 에러율: < 1%
...
4. **로그 확인**
   - Console 경로: CloudWatch > Log groups > /aws/all/week/1/services
   - 최근 로그 스트림 선택
   - 확인 항목:
     - 에러 메시지 없음
     - 성공 로그 확인
...
### 생성된 리소스 확인
- [ ] Exercise 1: All Week 1 Services 생성 완료
...
### 학습 목표 달성
- [ ] All Week 1 Services의 핵심 기능을 이해했는가?
...
**대시보드 삭제**:
- Console 경로: CloudWatch > Dashboards
- 선택: `day7-All Week 1 Services-monitoring`
- Delete dashboard
- 확인: "Delete" 버튼 클릭
...
#### 3. All Week 1 Services 삭제
- Console 경로: All Week 1 Services > Resources
- 선택: `day7-all-week-1-services`
- Actions > Delete
- 확인 옵션:
...
- 검색: `day7` 또는 `All Week 1 Services`
- 선택: 관련 로그 그룹
- Actions > Delete log group(s)
- 확인: "Delete" 버튼 클릭

### 정리 확인 체크리스트
- [ ] 모든 All Week 1 Services 리소스 삭제 완료
...
- 확인 항목:
  - 이번 달 누적 비용: $$0.50 - $2.00
  - All Week 1 Services 관련 비용: $$0.50 - $2.00
  - 예상 월말 비용: $$0.50 - $2.00

**예상 비용**:
- Free Tier 범위 내 실습: $0.00
- Free Tier 초과 시: $$0.50 - $2.00
...
### 핵심 개념
1. **All Week 1 Services 아키텍처**: All Week 1 Services의 기본 구조 및 동작 원리
...
### 이론 학습
- [Day 7 Theory](../theory.md) - All Week 1 Services 기본 개념
- [Day 6 Theory](../../day6/theory.md) - 사전 학습 내용
- [Day 8 Theory](../../day8/theory.md) - 다음 학습 내용

### 심화 학습
- [Case Study](../case-study.md) - Lyft의 All Week 1 Services 활용 사례
- [Best Practices](../best-practices.md) - All Week 1 Services 베스트 프랙티스
- [Troubleshooting](../troubleshooting.md) - 일반적인 문제 및 해결 방법

### AWS 공식 문서
- [All Week 1 Services User Guide](https://docs.aws.amazon.com/all-week-1-services/latest/userguide/)
- [All Week 1 Services API Reference](https://docs.aws.amazon.com/all-week-1-services/latest/APIReference/)
- [AWS Console User Guide](https://docs.aws.amazon.com/awsconsolehelpdocs/latest/gsg/)
- [Getting Started with All Week 1 Services](https://docs.aws.amazon.com/all-week-1-services/latest/gsg/)
