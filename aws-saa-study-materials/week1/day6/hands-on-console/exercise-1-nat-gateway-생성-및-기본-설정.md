...
## 🎯 실습 목표
AWS Console을 통해 NAT Gateway를 생성하고 기본 설정을 구성합니다.
...
**Console 경로**: `Services > AWS Services > NAT Gateway`

1. AWS Console 상단의 **Services** 메뉴 클릭
2. **AWS Services** 카테고리에서 **NAT Gateway** 선택
3. 화면 상단의 **"Create nat"** 또는 **"Launch nat"** 버튼 클릭
...
**상태 확인 방법**:
- Console 경로: `NAT Gateway > Resources` 또는 `NAT Gateway > Dashboard`
...
- [ ] NAT Gateway 리소스가 "Available" 또는 "Active" 상태인가?
- [ ] 리소스 이름이 올바르게 설정되었는가?
...
#### 1. NAT Gateway 리소스 삭제

**Console 경로**: `NAT Gateway > Resources`

1. 생성한 리소스 선택: `day6-nat-gateway`
2. **Actions** > **Delete** 클릭
