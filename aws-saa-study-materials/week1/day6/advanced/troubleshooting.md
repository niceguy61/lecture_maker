# Troubleshooting: NAT Gateway 문제 해결 가이드

## 📋 문서 정보
- **Day**: 6
- **주요 서비스**: NAT Gateway, VPC Peering, VPN, Direct Connect
- **작성일**: {date}
...
**대시보드 이름**: NAT Gateway-monitoring-dashboard

**핵심 메트릭 정의** (Day 6 서비스 기준):
...
**알람 구성 예시**:
```yaml
알람명: NAT Gateway-{metric_name}-alert
...
### 공식 트러블슈팅 가이드
- [NAT Gateway Troubleshooting]({troubleshooting_guide_link})
...
### 서비스별 베스트 프랙티스
- [NAT Gateway Best Practices]({best_practices_link})
